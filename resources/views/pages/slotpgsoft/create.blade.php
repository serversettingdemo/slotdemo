...
@section('content')
    ...
    <div class="content content-full content-boxed">
        ...
        <!-- New Post -->
        <form action="{{ route('pgsoft.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="block">
                <div class="block-header block-header-default">
                    <a class="btn btn-alt-secondary btn-sm" href="{{ route('pgsoft.index') }}">
                    ...
                    <div class="row justify-content-center push">
                        <div class="col-md-10">
                            <button type="submit" class="btn btn-alt-success">
                                <i class="fa fa-fw fa-check opacity-50 me-1"></i> Create pgsoft
                            </button>
                        </div>
                    </div>
                </div>
