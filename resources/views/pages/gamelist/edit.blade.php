        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
                <div class="row">
                    ...
                    <form action="{{ route('gamelist.update', $gamelist->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                    name="title" value="{{ old('title') ? old('title') : $gamelist->title }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control @error('iframe') is-invalid @enderror" id="iframe"
                                    name="iframe" value="{{ old('iframe') ? old('iframe') : $gamelist->iframe }}"
