   ...
   <div class="content">
      <div class="block block-rounded">
         <div class="block-header block-header-default">
            <h3 class="block-title">Edit Gamelist</h3>
         </div>
         ...
         <div class="block-content block-content-full">
            <div class="row">
               ...
               <form action="{{ route('gamelist.update', $gamelist->id) }}" method="post" enctype="multipart/form-data">
                  @method('PUT')
                  @csrf
                  ...
                  <div class="row">
                     <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                           name="title" value="{{ old('title') ? old('title') : $gamelist->title }}" placeholder="title"
                           required>
                        <!-- Error Not Required -->
                        @error('title')
                  ...
                  <div class="row">
                     <div class="col-lg-12 mb-4">
                        ...
                        <textarea id="js-ckeditor" name="body">{{ old('body') ? old('body') : $gamelist->body }}</textarea>
                     </div>
                  </div>
                     ...
                     <div class="col-md-6">
                        <div class="mb-4">
                           <input class="form-control @error('image') is-invalid @enderror mb-3" id="image" type="file"
                              name="image" value="{{ old('image') ? old('image') : $gamelist->image }}"
                              onchange="previewImage()">
                           <!-- menampilkan gambar lama -->
                           <input type="hidden" name="oldImage" value="{{ $gamelist->image }}">
                           @if ($gamelist->image)
                              <img src="{{ asset('storage/' . $gamelist->image) }}"
                                 class="image-preview img-fluid mt-3 col-sm-3 d-block" style="width: auto; height: 100px">
                           @else
